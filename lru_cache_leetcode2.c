...
// void unlinkElement(LRUCache *cache, Node *node)
// {
//     Node *prev, *next;
...
//     if (cache->elems ==0 )
//     {
//         printf("%s: No element in cache!\n", __FUNCTION__);
//         return; /* Nothing to unlink */
//     }

//     if (cache->elems == 1)
//     {
//         printf("%s: Element is the only element!\n", __FUNCTION__);
//         /* Since we are unlinking the only element in the cache head and tail must be null*/
//         cache->head = NULL;
//         cache->tail = NULL;
//         node->next = NULL;
//         node->prev = NULL;
